...
$(document).ready(function () {
    ...
    var SendUsers = "http://localhost:45475/DashboardUserOperations.svc/DashboardUserOperations/ShowAllAccessRights/" + DashboardID
    [1];
    ...
    $("#send").on("click", function () {
        ...
        for (var l = 0; l < names.length; l++) {
            ...
            projectusers.push({ DashboardId: DashboardID, UserId: idTosend[l], AccessRight: AccessRight, Name: names[l].innerHTML });
        }
        var jData = {};
    ...
    $(".AddToExistingList").click(function () {
        ...
        for (var iterator = 0; iterator < nameAndId_existing.length; iterator++) {
            var accessRight_existing = nameAndId_existing[iterator].AccessRight.AccessRightName;
